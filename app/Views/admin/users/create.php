                        ...
                        <form action="<?= base_url('admin/users/create') ?>" method="post">
                            ...
                            <div class="row mb-3">
                                <div class="col">
                                    ...
                                    <input type="number" name="no_hp" value="<?= old('no_hp') ?>" class="form-control" id="no_hp">
                                </div>
                                <div class="col">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col">
                                    ...
                                    <input type="password" name="password_conf" value="<?= old('password_conf') ?>" class="form-control" id="password_conf" required>
                                </div>
                            </div>
